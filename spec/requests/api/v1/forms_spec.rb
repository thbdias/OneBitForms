...
RSpec.describe "Api::V1::Forms", type: :request do
  ...
  # TESTES INDEX
  #descrevendo qual url que vai testar e qual tipo de requisição (GET)
  describe "GET /forms" do
    # garantir que alguém não logado não consiga obter a lista de forms
    context "With Invalid authentication headers" do
      it_behaves_like :deny_without_authorization, :get, "/api/v1/forms"
    end
 
    # header tem autenticação correta
  ...
  # TESTES SHOW
  # friendly_id -> gem -> para não ficar /form/1 ou /form/2 ... -> gera um id mais 'humano', fácil de entender
  ...
  describe "POST /forms" do
    ...
    context "With valid authentication headers" do
      ...
      context "And with valid params" do
        ...
        # se no banco de dados criou certo
      ...
      context "When form exists" do
        ...
        context "And user is the owner" do
          ...
          it "form are updated with correct data" do
            # ter certeza que o que tem é o que tem no banco, mais atualizado
            @form.reload
            @form_attributes.each do |field|
